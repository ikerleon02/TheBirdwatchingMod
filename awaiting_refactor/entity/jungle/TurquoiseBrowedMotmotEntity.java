...
public class TurquoiseBrowedMotmotEntity extends DiurnalBirdEntity {

    public TurquoiseBrowedMotmotEntity(EntityType<? extends AnimalEntity> type, World worldIn) {
        super(type, worldIn);
    }
    ...
    public void mobTick() {
        ...
        {
            this.dropItem(InitItems.MOTMOTFEATHER, 1);
