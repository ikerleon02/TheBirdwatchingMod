...
public class TBMConfiguredFeatures{
    ...
    public static final ConfiguredFeature<TreeFeatureConfig, ?> OLDBIRCH = register("oldbirch", Feature.TREE.configure((new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.BIRCH_LOG.getDefaultState()), new ForkingTrunkPlacer(5, 2, 2), new SimpleBlockStateProvider(Blocks.BIRCH_LEAVES.getDefaultState()), new SimpleBlockStateProvider(Blocks.BIRCH_SAPLING.getDefaultState()), new AcaciaFoliagePlacer(ConstantIntProvider.create(2), ConstantIntProvider.create(0)), new TwoLayersFeatureSize(1, 0, 2))).build()));
    ...
    public static final ConfiguredFeature<?, ?> MOUNTAIN_OLD_BIRCH_TREES = register("mountain_old_birch_trees", Feature.RANDOM_SELECTOR.configure(
            new RandomFeatureConfig(
                    ImmutableList.of(
                            Feature.TREE.configure(TBMConfiguredFeatures.FALLEN_OAK_TREE_CONFIG).withChance(0.2F)
