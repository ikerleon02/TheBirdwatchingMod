...
public class EntityEasternBluebird extends EntityBirdDiurnal{
	...
	public EntityEasternBluebird(World worldIn) {
		...
		if(this.world.isRemote) {
			Animation speakmale = new Animation(PosesUtil.EASTERN_BLUEBIRD_SPEAKING_POSE_1, PosesUtil.EASTERN_BLUEBIRD_SPEAKING_POSE_2);
			speakmale.speed = 0.3F;
			Animation speakfemale = new Animation(PosesUtil.EASTERN_BLUEBIRD_SPEAKING_POSE_1, PosesUtil.EASTERN_BLUEBIRD_SPEAKING_POSE_2);
