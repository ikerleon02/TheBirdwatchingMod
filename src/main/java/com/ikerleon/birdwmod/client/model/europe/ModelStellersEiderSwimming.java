...
/**
 * ModelStellersEiderSwimming - starcook
 * Created using Tabula 7.0.0
 */
@SideOnly(Side.CLIENT)
public class ModelStellersEiderSwimming extends ModelStellersEider {

    public ModelStellersEiderSwimming() {
        this.textureWidth = 128;
        this.textureHeight = 64;
        this.rightwing2.setRotationPoint(-0.1F, -4.5F, 1.0F);
        this.rightwing2.addBox(-0.4F, -5.5F, -2.8F, 1, 6, 3, 0.0F);
        this.setRotateAngle(rightwing2, 0.17453292519943295F, 0.0F, -0.08726646259971647F);
        this.belly.setRotationPoint(0.0F, 4.4F, -2.3F);
        this.belly.addBox(-2.0F, 0.0F, 0.0F, 4, 3, 4, 0.0F);
        this.setRotateAngle(belly, 1.6845917940249266F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(belly2, 2.86844862565268F, 0.0F, 0.0F);
        this.neckfront.setRotationPoint(0.0F, -0.3F, -1.7F);
        this.neckfront.addBox(-1.0F, -1.0F, -3.0F, 2, 2, 4, 0.0F);
        this.setRotateAngle(neckfront, 0.4363323129985824F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(body, 1.7453292519943295F, -3.141592653589793F, 0.0F);
        ...
        this.setRotateAngle(rightleg, -2.443460952792061F, 0.0F, 0.0F);
        this.neckback.setRotationPoint(0.0F, 1.4F, -0.9F);
        this.neckback.addBox(-1.5F, -2.0F, -4.0F, 3, 2, 4, 0.0F);
        this.setRotateAngle(neckback, 0.3490658503988659F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(rightwing, -0.17453292519943295F, 0.0F, 0.0F);
        this.leftwing.setRotationPoint(-2.3F, 3.7F, 1.6F);
        this.leftwing.addBox(-0.6F, -4.5F, -2.0F, 1, 5, 4, 0.0F);
        this.setRotateAngle(leftwing, -0.17453292519943295F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(leftwing2, 0.17453292519943295F, 0.0F, 0.08726646259971647F);
        this.leftleg.setRotationPoint(-1.3F, -2.5F, -0.3F);
        this.leftleg.addBox(-0.5F, 0.0F, -0.5F, 1, 3, 1, 0.0F);
        this.setRotateAngle(leftleg, -2.443460952792061F, 0.0F, 0.0F);
        this.head.setRotationPoint(0.0F, 0.4F, -3.1F);
        this.head.addBox(-2.0F, -1.6F, -1.6F, 4, 3, 4, 0.0F);
        this.setRotateAngle(head, 1.48352986419518F, 0.0F, 0.0F);
