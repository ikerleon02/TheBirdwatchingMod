...
/**
 * ModelKilldeerFlying - ikerleon
 * Created using Tabula 7.0.0
 */
@SideOnly(Side.CLIENT)
public class ModelKilldeerFlying extends ModelKilldeer {

    public ModelKilldeerFlying() {
        ...
        this.setRotateAngle(bellyback, 2.0032889154390916F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(tailleft, 0.0F, 0.4363323129985824F, -0.17453292519943295F);
        this.leftleg2.setRotationPoint(0.0F, 3.7F, 0.1F);
        this.leftleg2.addBox(-0.5F, 0.0F, -0.5F, 1, 4, 1, 0.0F);
        this.neckbottom.setRotationPoint(0.0F, 3.0F, 3.0F);
        this.neckbottom.addBox(-2.0F, -3.3F, -3.0F, 4, 3, 3, 0.0F);
        this.setRotateAngle(neckbottom, 0.5462880558742251F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(necktop, 1.4114477660878142F, 0.0F, 0.0F);
        this.neckbottom_1.setRotationPoint(0.0F, -3.1F, -3.0F);
        this.neckbottom_1.addBox(-1.5F, 0.0F, -0.0F, 3, 3, 2, 0.0F);
        this.setRotateAngle(neckbottom_1, 0.7285004297824331F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(tailright, 0.0F, -0.4363323129985824F, 0.17453292519943295F);
        ...
        this.setRotateAngle(rightwing, -1.2217304763960306F, -0.05235987755982988F, 1.48352986419518F);
