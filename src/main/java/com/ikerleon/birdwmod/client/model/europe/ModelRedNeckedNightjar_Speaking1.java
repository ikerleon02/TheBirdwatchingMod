...
/**
 * ModelRedNeckedNightjar_Speaking1 - ikerleon
 * Created using Tabula 7.0.0
 */
@SideOnly(Side.CLIENT)
public class ModelRedNeckedNightjar_Speaking1 extends ModelRedNeckedNightjar {

    public ModelRedNeckedNightjar_Speaking1() {
