...
public class ModelRedFlankedBluetail extends BookwormModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        if ((entityIn instanceof EntityRedFlankedBluetail)) {
            ...
            this.body2.rotateAngleX += MathHelper.cos(bluetail.ticksExisted * 0.17f + 2.5F) * 0.05F * 1 * 0.5f + 0 * 0.5f;
            this.head.rotateAngleX += MathHelper.cos(bluetail.ticksExisted * 0.2f + 2.5F) * 0.06F * 1 * 0.5f + 0 * 0.5f;
            this.rightwing.rotateAngleX += MathHelper.cos(bluetail.ticksExisted * 0.17f + 2.5F) * 0.03F * -1 * 0.5f + 0 * 0.5f;
            this.rightwing_1.rotateAngleX += MathHelper.cos(bluetail.ticksExisted * 0.17f + 2.5F) * 0.03F * -1 * 0.5f + 0 * 0.5f;
            ...
            if (!bluetail.onGround && !bluetail.isInWater() && !bluetail.isChild()) {
                ...
                this.rightwing.rotateAngleX += MathHelper.cos(bluetail.ticksExisted * 0.6f * globalSpeed + 0) * 0.2f * globalDegree * -1 * 0.5f + 0 * 0.5f;
                this.rightwing_1.rotateAngleX += MathHelper.cos(bluetail.ticksExisted * 0.6f * globalSpeed + 0) * 0.2f * globalDegree * -1 * 0.5f + 0 * 0.5f;
                this.rightwing.rotateAngleZ += MathHelper.cos(bluetail.ticksExisted * 0.3f * globalSpeed + 0) * 0.4f * globalDegree * -1 * 0.5f + 0 * 0.5f;
                this.rightwing_1.rotateAngleZ += MathHelper.cos(bluetail.ticksExisted * 0.3f * globalSpeed + 0) * 0.4f * globalDegree * 1 * 0.5f + 0 * 0.5f;
