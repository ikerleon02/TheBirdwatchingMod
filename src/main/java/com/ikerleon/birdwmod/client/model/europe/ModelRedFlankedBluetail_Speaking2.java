...
/**
 * ModelRedFlankedBluetail_Speaking2 - Jaz
 * Created using Tabula 7.0.0
 */
@SideOnly(Side.CLIENT)
public class ModelRedFlankedBluetail_Speaking2 extends ModelRedFlankedBluetail {

    public ModelRedFlankedBluetail_Speaking2() {
