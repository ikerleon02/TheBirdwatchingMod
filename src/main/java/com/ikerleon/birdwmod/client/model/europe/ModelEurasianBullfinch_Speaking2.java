...
/**
 * ModelEurasianBullfinch_Speaking2 - ikerleon02
 * Created using Tabula 7.0.0
 */
@SideOnly(Side.CLIENT)
public class ModelEurasianBullfinch_Speaking2 extends ModelEurasianBullfinch {

    public ModelEurasianBullfinch_Speaking2() {
        ...
        this.setRotateAngle(beakbase, 0.4363323129985824F, 0.0F, 0.0F);
