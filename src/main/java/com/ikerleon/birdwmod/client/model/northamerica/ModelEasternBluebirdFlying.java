...
/**
 * ModelEasternBluebirdFlying - ikerleon02
 * Created using Tabula 7.0.0
 */
@SideOnly(Side.CLIENT)
public class ModelEasternBluebirdFlying extends ModelEasternBluebird {

    public ModelEasternBluebirdFlying() {
        ...
        this.setRotateAngle(belly2, 1.2217304763960306F, 0.0F, 0.0F);
        this.shape13.setRotationPoint(0.0F, 1.7F, 8.2F);
        this.shape13.addBox(-1.5F, 0.0F, -8.0F, 3, 3, 8, 0.0F);
        this.setRotateAngle(shape13, -0.22689280275926282F, 0.0F, 0.0F);
