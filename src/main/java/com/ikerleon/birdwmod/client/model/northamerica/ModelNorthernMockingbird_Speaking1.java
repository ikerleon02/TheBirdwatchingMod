...
/**
 * ModelNorthernMockingbird_Speaking1 - ikerleon
 * Created using Tabula 7.0.0
 */
@SideOnly(Side.CLIENT)
public class ModelNorthernMockingbird_Speaking1 extends ModelNorthernMockingbird {

    public ModelNorthernMockingbird_Speaking1() {
        ...
        this.setRotateAngle(beak, 0.2617993877991494F, 0.0F, 0.0F);
