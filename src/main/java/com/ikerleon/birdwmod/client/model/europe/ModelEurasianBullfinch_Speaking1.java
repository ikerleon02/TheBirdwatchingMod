...
/**
 * ModelEurasianBullfinch_Speaking1 - ikerleon02
 * Created using Tabula 7.0.0
 */
@SideOnly(Side.CLIENT)
public class ModelEurasianBullfinch_Speaking1 extends ModelEurasianBullfinch {

    public ModelEurasianBullfinch_Speaking1() {
        ...
        this.setRotateAngle(beakbase, 0.22689280275926282F, 0.0F, 0.0F);
