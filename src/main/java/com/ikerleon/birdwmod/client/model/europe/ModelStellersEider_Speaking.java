...
/**
 * ModelStellersEider_Speaking - starcook
 * Created using Tabula 7.0.0
 */
@SideOnly(Side.CLIENT)
public class ModelStellersEider_Speaking extends ModelStellersEider {

    public ModelStellersEider_Speaking() {
        ...
        this.setRotateAngle(head, 1.7453292519943295F, 0.0F, 0.0F);
