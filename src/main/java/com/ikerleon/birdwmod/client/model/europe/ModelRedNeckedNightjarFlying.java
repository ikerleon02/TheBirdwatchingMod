...
/**
 * ModelRedNeckedNightjarFlying - ikerleon
 * Created using Tabula 7.0.0
 */
@SideOnly(Side.CLIENT)
public class ModelRedNeckedNightjarFlying extends ModelRedNeckedNightjar {

    public ModelRedNeckedNightjarFlying() {
        this.textureWidth = 128;
        this.textureHeight = 64;
        this.rightwing3.setRotationPoint(0.7F, 1.7F, 4.5F);
        this.rightwing3.addBox(-1.0F, 0.0F, 0.0F, 1, 2, 8, 0.0F);
        this.setRotateAngle(rightwing3, 0.08726646259971647F, 0.0F, -0.03490658503988659F);
        ...
        this.setRotateAngle(leftwing3, 0.08726646259971647F, 0.0F, -0.03490658503988659F);
        ...
        this.setRotateAngle(necktop, -0.136659280431156F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(leftwing, -1.48352986419518F, 0.0F, -1.48352986419518F);
        ...
        this.setRotateAngle(tail2, 0.2617993877991494F, -0.05235987755982988F, 0.0F);
        ...
        this.setRotateAngle(neckbottom2, -1.3203415791337103F, 0.0F, 0.0F);
        this.rightwing.setRotationPoint(-2.7F, 3.0F, 3.0F);
        this.rightwing.addBox(-1.0F, -3.0F, -2.0F, 1, 5, 7, 0.0F);
        this.setRotateAngle(rightwing, -1.48352986419518F, 0.0F, 1.48352986419518F);
        ...
        this.setRotateAngle(tail3, 0.2617993877991494F, 0.05235987755982988F, 0.0F);
    }
}
