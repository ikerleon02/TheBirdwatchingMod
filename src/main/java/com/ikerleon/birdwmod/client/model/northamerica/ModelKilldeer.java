...
public class ModelKilldeer extends BookwormModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        if ((entityIn instanceof EntityKilldeer)) {
            ...
            this.rightwing_1.rotateAngleX = MathHelper.cos(killdeer.ticksExisted * 0.17f) * 0.03F * -1 * 0.5f;
            ...
            if (!killdeer.onGround && !killdeer.isInWater() && !killdeer.isChild()) {
                ...
                this.rightwing_1.rotateAngleX = MathHelper.cos(killdeer.ticksExisted * 0.6f * globalSpeed + 0) * 0.2f * globalDegree * -1 * 0.5f - 2.5F * 0.5f;
                this.rightwing.rotateAngleZ = MathHelper.cos(killdeer.ticksExisted * 0.3f * globalSpeed + 0) * 0.4f * globalDegree * -1 * 0.5f + 3F * 0.5f;
                this.rightwing_1.rotateAngleZ = MathHelper.cos(killdeer.ticksExisted * 0.3f * globalSpeed + 0) * 0.4f * globalDegree * 1 * 0.5f - 3F * 0.5f;
